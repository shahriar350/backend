...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('common/image/logoOnly.png') }}">
    <link rel="stylesheet" href="{{ asset('common/boxicons/css/boxicons.min.css') }}">
...
<div class="wrapper" id="app">
    ...
    <div class="left-side-menu">
        ...
        <a href="{{ route('admin.dashboard') }}" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="{{ asset('common/image/logo.png') }}" alt="" height="16">
                    </span>
            <span class="logo-sm">
                        <img src="{{ asset('common/image/logoOnly.png') }}" alt="" height="16">
                    </span>
        </a>
    ...
    <div class="content-page">
            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topbar-right-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="false" aria-expanded="false">
                            <i class="bx bx-bell noti-icon"></i>
                    ...
                    <li class="dropdown notification-list d-none d-sm-inline-block">
                        <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="false" aria-expanded="false">
                            <i class="bx bx-desktop noti-icon"></i>
                        </a>
                    ...
                    <li class="notification-list">
                        <a class="nav-link right-bar-toggle" href="javascript: void(0);">
                            <i class="bx bx-abacus noti-icon"></i>
                        </a>
                    </li>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" href="#"
                           ...
                           aria-expanded="false">
                            ...
                            <span>
                                        <span class="account-user-name">{{ ucfirst(getadmin()->name)  }}</span>
                                        <span class="account-position">
                                            @foreach(getadminroles() as $userrole)
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        2018 - 2020 © Hyper - Bongobitan.com
                    </div>
                    <div class="col-md-6">
